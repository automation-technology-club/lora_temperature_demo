...
/* 
 *  Setup a Google Sheet to display Temperature Data using Pushingbox.
...
void updateGoogle() {
  if (espClient.connect(WEBSITE, 80))
      { 
         espClient.print("GET /pushingbox?devid=" + devid
       + "&node=" + (String) n
       + "&t="      + (String) t
       + "&h="     + (String) h
         );
